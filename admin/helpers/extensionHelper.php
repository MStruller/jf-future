...
class  JoomfishExtensionHelper  {
	...
	public static function getExtraPath($path = '') 
	{
		...
		$base = JPATH::clean(JOOMFISH_ADMINPATH .DS. 'models');
		$baseJF = JPATH::clean(JOOMFISH_ADMINPATH .DS. 'models'.DS.'jf');
		$extraPaths['base'] = $base;
		$extraPaths['baseJF'] = $baseJF;
		$extraPaths['element'] = $base;//.DS.'element';	// ContentElement
		$extraPaths['filters'] = $base; //$base.DS.'filters';	// TranslationFilter
		//$extraPaths['filters'] = JPATH::clean(JOOMFISH_ADMINPATH .DS.'contentelements'); //$base.DS.'filters';	// TranslationFilter
		$extraPaths['forms'] = $baseJF.DS.'forms';		// TranslateForms
		$extraPaths['models'] = $baseJF.DS.'models';		// TranslateModel
		$extraPaths['objects'] = $base;//.DS.'objects';	// TranslationObject
		$extraPaths['params'] = $baseJF.DS.'params';		// TranslateParam
		//$extraPaths['xmls'] = $base.DS.'xmls';		// contentelements
		$extraPaths['contentelements'] = JPATH::clean(JOOMFISH_ADMINPATH .DS.'contentelements');	// contentelements
		$extraPaths['languageconfig'] = JPATH::clean(JOOMFISH_ADMINPATH .DS.'contentelements');	// contentelements
