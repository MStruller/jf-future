...
$this->orig_model = new MenusModelItem(array('ignore_request'=>true));

only need without the next?
and load over the $this->orig_model->getItem?


$this->orig_model->setState('item.id',$contentid);
$this->orig_model->setState('item.type',$pageTypeType->type);
$this->orig_model->setState('item.menutype',$menutype);
$this->orig_model->setState('item.parent_id',$parent_id);
